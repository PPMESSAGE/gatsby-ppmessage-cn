    ...
    <div className={styles.container}>
      <div className={styles.bg__light}>
        ...
        <div className={styles.u__hidden1}>
          <img src="https://marketing.intercomassets.com/assets/live-chat/v2/hero-right-d02e3911a1ef5f33a27b2cf4b63fd1c0f0ea541bdf3fff1cbea6379f22fcbb33.png" />
        </div>
        <div className={styles.u__zfix}>
          <h1 className={styles.t__h1}>
            增长最快的销售和营销团队通过Intercom达到了他们的数量
          </h1>
          <div style={{height:"10px"}}></div>
          <h2 className={styles.t__h3}><font>通过机器人和实时聊天，获得更多潜在客户，自动化资格认证并通过管道更快地交易。</font>
          </h2>
        ...
        <div className={styles.u__hidden__md}>
          <div className={styles.f__center}>
            <font className={styles.fangwen}>
              如果访问者在网站上使用Intercom的实时聊天功能，他们转换的可能性将增加82％
            </font>
          </div>
        </div>
      </div>
        ...
        <div className={styles.g__row}>
          <div className={styles.g__c6}>
            ...
            <div className={styles.max__600}>
              <font>在一个收件箱中一起工作。无论他们写什么渠道，都能快速响应客户。
              </font>
            </div>
          </div>
      ...
      <div className={styles.container_z}>
        <div className={styles.support_automate}>
          ...
          <div className={styles.g__c6}>
            ...
            <div style={{height:"10px"}}></div>
            <div className={styles.max__600}>
              <font>向客户推荐相关文章，以便他们自助。加快工作速度，提高团队效率。
              </font>
            </div>
        ...
        <div className={styles.g__row_z}>
          ...
          <div className={styles.g__c5_z}>
            ...
            <div className={styles.max__550}>
              <font className={styles.tigongzhichi}>使用我们的知识库软件组织建议，答案，文档等。为您的客户提供始终可用的帮助。
              </font>
            </div>
            ...
            <div className={styles.g__row_f}>
              <div className={styles.g__c6}>
                <div className={styles.f__left}>
                  ...
                  <div className={styles.sp__left_4}>
                    <div className={styles.t__small}>
                      <font>只需单击一次即可导入</font>
                    </div>
                    <div style={{height:"10px"}}></div>
                    <div className={styles.t__small}>
                      轻松迁移Zendesk，Desk.com，Help Scout等现有的公共知识库。
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className={styles.container_z}>
        <div className={styles.g__row}>
          <div className={styles.g__c6}>
            ...
            <div style={{height:"10px"}}></div>
            <div className={styles.max__600}>
              <font>获取管理团队所需的信息，以及反馈循环，告诉您文章的有用性。知道在哪里进行更新。
              </font>
            </div>
          </div>
