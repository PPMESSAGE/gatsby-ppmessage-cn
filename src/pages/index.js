  ...
  <div>
      ...
      <div className={styles.g__row}>
        <div className={styles.g__c6}>
          <div className={styles.sp__5}>
            ...
            <h3 style={{color:'#888'}}>现代产品用于销售，营销和支持，以便与客户建立联系并更快的发展。
            </h3>
    ...
    <section>
      <div className={styles.f__center}>
        <h3 className={styles.f__h3}>
          <font style={{color:"#888"}}>受到全球最具创新精神的企业信赖- 无论大小
          </font>
        </h3>
        <div style={{height:'20px'}}>
        </div>
    ...
    <section>
      ...
      <div className={styles.container__narrower}>
        ...
        <div style={{height:"30px"}}></div>
        <div className={styles.container__narrower}>
          <h5 className={styles.f__center1}><font>支持销售转化率，客户满意度、客户工作量、会话来源等多种报表类型，各项业务数据完美呈现
        ...
        <div className={styles.g__c6}>
          ...
          <div className={styles.device__grey}>
            <div className={styles.t__h2}>
              <font>"Intercom 是一个无价的工具，可以帮助我们通过渠道的每一步推动销售和支持。"
              </font>
